...
const eventList: EventItem[] = [
    { id: 1, category: 'Arts & Culture', title: 'Annual Spring Concert', description: 'Join us for a night of music featuring the university orchestra and choir.', date: 'Tuesday, April 15', time: '7:00 PM', location: 'University Auditorium', dayNum: 15, dayAbbr: 'Tue' },
    { id: 2, category: 'Career', title: 'Career Fair', description: 'Connect with potential employers and explore career opportunities.', date: 'Tuesday, April 25', time: '10:00 AM', location: 'Student Center', dayNum: 25, dayAbbr: 'Tue' },
    { id: 3, category: 'Academic', title: 'Tech Workshop: AI Fundamentals', description: 'Learn the basics of artificial intelligence and machine learning.', date: 'Friday, April 28', time: '2:00 PM', location: 'Engineering Building, Room 305', dayNum: 28, dayAbbr: 'Fri' },
    { id: 4, category: 'Sports', title: 'Basketball Tournament', description: 'Annual inter-department basketball competition.', date: 'Wednesday, May 2', time: '9:00 AM', location: 'University Sports Complex', dayNum: 2, dayAbbr: 'Wed' },
    { id: 5, category: 'Social', title: 'Student Club Fair', description: 'Explore the various student clubs and organizations on campus.', date: 'Saturday, May 5', time: '11:00 AM', location: 'Main Quad', dayNum: 5, dayAbbr: 'Sat' },
    { id: 6, category: 'Academic', title: 'Research Symposium', description: 'Undergraduate and graduate students present their research projects.', date: 'Thursday, May 10', time: '1:00 PM', location: 'Science Center', dayNum: 10, dayAbbr: 'Thu' },
];
    ...
    <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden flex flex-col h-full">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-2 bg-white/70 backdrop-blur-sm">
                <div className="flex justify-between items-end">
                    ...
                    <div className="text-center">
                        ...
                        <div className="text-xs font-semibold text-gray-700 leading-none">{event.dayAbbr}</div>
                        <div className="text-lg font-bold text-orange-600 leading-none">{event.dayNum}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="p-4 flex flex-col grow">
            ...
            <div className="pt-4 mt-2">
                <Link to={`/view-details`} className="block w-full text-center py-2 text-sm font-medium text-white bg-gray-900 rounded-lg hover:bg-gray-700 transition">
                    View Details
                </Link>
            </div>
        </div>
