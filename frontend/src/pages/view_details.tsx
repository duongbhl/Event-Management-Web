        ...
        <div className="min-h-screen bg-gray-50 flex flex-col">
            <main className="container mx-auto p-4 sm:p-6 lg:p-8 grow">
                ...
                <div className="flex justify-between items-center mb-6">
                    <Link to="/" className="text-orange-600 hover:text-orange-800 flex items-center text-sm font-medium">
                            ...
                            <div className="sticky top-20 bg-gray-50 border border-gray-300 rounded-lg p-6 shadow-md">
                                ...
                                {false ? (
                                    <>
                                        ...
                                        <button className="w-full mt-3 py-3 text-red-600 border border-red-300 rounded-lg hover:bg-red-50 transition">
                                            Cancel Registration
                                        </button>
                                    </>
                                ) : (
